...
Once you are set up, [connect to your amazon EC2 instance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AccessingInstancesLinux.html){target="_blank"} using the terminal app. Then use the [screen](https://kb.iu.edu/d/acuy){target="_blank"} command to run your scraper. This will keep your code running even after you disconnect from youe EC2 instance, even after you shut down your computer, even after you throw your computer off a bridge, etc, etc. 
